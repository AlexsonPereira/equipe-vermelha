...
import { Crown, HeartHandshake, Copy, Check, Church, Flame, Smartphone, Quote, MapPin } from 'lucide-react';
...
export default function App() {
  ...
  const handleCopyPix = () => {
    copyToClipboard('pix@macguanambi.com.br'); // Substitua pela chave real
    setCopied(true);
      ...
      <section className="relative min-h-screen flex flex-col items-center justify-center overflow-hidden pt-20 pb-16 px-4">
        ...
        <div className="relative z-10 flex flex-col items-center text-center w-full max-w-4xl mx-auto">
          ...
          <motion.div
            ...
            className="mt-12 flex flex-col sm:flex-row gap-4 w-full justify-center px-4"
          >
          ...
          >
            ...
            <div className="grid lg:grid-cols-2 gap-12 items-center">
              ...
              <div className="flex flex-col items-center justify-center p-6 md:p-8 bg-black/40 rounded-2xl border border-white/5">
                ...
                <div className="w-48 h-48 bg-white p-2 rounded-xl mb-6 shadow-inner flex items-center justify-center">
                  <div className="border-4 border-black border-dashed w-full h-full flex flex-col items-center justify-center text-black/40 font-bold text-center p-4">
                ...
                <div className="w-full relative max-w-sm">
                  ...
                  >
                    <span className="truncate mr-4 text-sm md:text-base text-gray-300 select-all">pix@macguanambi.com.br</span>
              ...
              <div className="flex flex-col justify-center w-full">
                ...
                <div className="space-y-6">
                  {[
                    { name: 'Arroz & Feijão', meta: 'Meta: 500kg', progress: '65%' },
                    { name: 'Óleo de Soja', meta: 'Meta: 200 un.', progress: '40%' },
                    { name: 'Leite em Pó', meta: 'Meta: 100 latas', progress: '25%' },
                  ].map((item, idx) => (
